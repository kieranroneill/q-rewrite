...
class TestEquivalenceSuccess:
    def test_identity_then_removed(self, verifier):
        ...
        result = verifier.verify(reference_circuit=reference, candidate_circuit=candidate)
...
class TestEdgeCases:
    def test_identical_circuit(self, verifier):
        ...
        result = verifier.verify(reference_circuit=circuit, candidate_circuit=circuit.copy())
